...
class MasterDaySchedule extends StatelessWidget {
  final MasterScheduleController ctrl = Get.put(MasterScheduleController());

  @override
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
        title: Text('Список актов на сегодня  ${GetStorage().read('master_id')}'),
...
//// =>
                              ListTile(
                                onTap: () =>  Get.offAllNamed(Routes.MASTER_IMPLEMENT, arguments: ctrl.implementsSchedule[index].id),//ctrl.onItemInit(ctrl.implementsSchedule[index].id),
